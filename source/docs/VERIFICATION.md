...
Startup update: game JavaScript and styling are embedded in index.html; automatic opening, failure recovery, compiled module syntax and relative artwork paths passed local checks. See STARTUP-FIX.md.
