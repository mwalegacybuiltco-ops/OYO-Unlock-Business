const PREFIX='oyo-shell-'+new URL(self.registration.scope).pathname+'-';const CACHE=PREFIX+'9acd292c172c';const SHELL=["./","./icon-192.png","./icon-512.png","./icon.svg","./index.html","./manifest.webmanifest","./reach-characters.png","./unwritten-reach.png"].map(path=>new URL(path,self.registration.scope).href);
